...
// Importation du nouvel écran de chargement
import LoadingToQuizScreen from './screens/LoadingToQuizScreen'; 
        ...
        <SafeAreaView style={styles.homeContainer}>
            <View style={styles.innerHome}>
                ...
                <TouchableOpacity 
                    ...
                    // CHANGEMENT: Navigue vers 'LoadingToQuiz'
                    onPress={() => navigation.navigate('LoadingToQuiz')}
                >
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="Home">
                ...
                />
                {/* NOUVELLE ROUTE: L'écran de chargement */}
                <Stack.Screen 
                    name="LoadingToQuiz" 
                    component={LoadingToQuizScreen} 
                    options={{ headerShown: false }}
                />
                <Stack.Screen 
                    name="Quiz" 
